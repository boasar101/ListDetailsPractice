...
import com.example.listdetailspractice.ListDetailsPracticeApp
import com.example.listdetailspractice.ui.vm.FavoritesViewModel
import com.example.listdetailspractice.ui.vm.FavoritesViewModelFactory

@Composable
fun FavoritesScreen(
    onRepoClick: (Long) -> Unit
) {
    val app = LocalContext.current.applicationContext as ListDetailsPracticeApp
